   ...
   <div class="-mt-10 flex relative">
    <div class=" px-4 max-w-screen-xl mx-auto w-full">
      ...
      <div class="relative  ml-6 md:ml-12">
        ...
        <button class="bg-[#4595eb]   py-2 font-extrabold px-5 rounded bg-gradient-to-l from-cyan-500 to-blue-500 transform hover:scale-105">About Me</button>
    ...
    <ul class="ml-auto space-y-6 absolute right-8  text-[#b0b2c3]"  >
        <li class="w-7 hover:text-white">
            <a href="https://www.linkedin.com/in/ashutosh-gupta-820a09215/" target="_blank">
        ...
        <li class ="w-7 hover:text-white">
            <a href="https://www.instagram.com/_ashu9795/" target="_blank"><svg class="full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
        ...
        <li class ="w-7 hover:text-white">
            <a href="https://github.com/ashu9795" target="_blank">
                <svg class="full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
                    <path
                    fill="currentColor"
        ...
        <li class ="w-7 hover:text-white">
            <a href="mailto:ashutoshg067@gmail.com" target="_blank">
                <svg class="full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    <path
                        fill="currentColor"
