   ...
   const [hoveredSvgName, setHoveredSvgName] = useState(''); // State to store the name of the hovered SVG
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50">
            <div 
                ref={modalRef} 
                className="bg-gray-800 text-white rounded-lg p-6 w-11/12 sm:w-80 md:w-96 lg:w-[800px] lg:left-0  relative" // Adjust width and position for larger screens
            >
                <button
                    onClick={onClose}
...
<p className="mt-4 fredoka-regular">
  ...
  Performance and security are given the utmost importance. Enjoys puzzles and writing good code.
                ...
                <p className="text-gray-400 text-sm  fredoka-regular mb-3">{hoveredSvgName === 'MongoDB' ? 'MongoDB' : ''}</p>   
              <svg
    ...
    class=""
    onMouseEnter={() => setHoveredSvgName('MongoDB')}
...
<div className="flex flex-col items-center">
<p className="text-gray-400 text-sm  fredoka-regular mb-3">{hoveredSvgName === 'Express' ? 'Express' : ''}</p> 
<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 32 32"
    width="50"
    height="50"
    onMouseEnter={() => setHoveredSvgName('Express')}
                        onMouseLeave={() => setHoveredSvgName('')}
>
    <g fill="#ffff">
        <path
...
<div className="flex flex-col items-center">
                <p className="text-gray-400 text-sm  fredoka-regular mb-3">{hoveredSvgName === 'React' ? 'React' : ''}</p>  
                <svg
    width="50"
    height="50"
    viewBox="175.7 78 490.6 436.9"
    xmlns="http://www.w3.org/2000/svg"
    onMouseEnter={() => setHoveredSvgName('React')}
                        onMouseLeave={() => setHoveredSvgName('')}
>
    <g fill="#61dafb">
        <path
...
<p className="text-gray-400 text-sm  fredoka-regular mb-3">{hoveredSvgName === 'Node.Js' ? 'Node.Js' : ''}</p>  
                <svg 
    width="50"
    height="50"
    viewBox="0 0 256 282"
    ...
    onMouseEnter={() => setHoveredSvgName('Node.Js')}
                        onMouseLeave={() => setHoveredSvgName('')}
>
    <g fill="#8CC84B">
        <path
