...
function Footer() {
  return (
    <div>
      ...
      <p class="text-xs ">Ashutosh Gupta © 2024</p>
      ...
      <ul className="mx-auto flex items-center justify-center gap-6 text-[#b0b2c3] size-5/12"  >
        ...
        <li class ="w-5 hover:text-white">
            <a href="https://www.instagram.com/_ashu9795/" target="_self"><svg class="full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
